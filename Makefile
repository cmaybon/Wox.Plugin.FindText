...
WoxVersion = 1.3.524
PluginDirectory = "%LOCALAPPDATA%\Wox\app-${WoxVersion}\Plugins\FindText"
BuildDirectory = "${RootPath}\__build"
PluginName = "Wox.Plugin.FindText"
...
copy_plugin:
	...
	copy "${RootPath}\find_text.py" "${PluginDirectory}"
...
zip:
	...
	copy "${RootPath}\find_text.py" "${BuildTempDirectory}"
